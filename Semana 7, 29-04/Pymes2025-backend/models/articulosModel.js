...
const sequelize = require('./configurarSequelize'); // Importa la instancia de Sequelize correctamente
...
const articulos = sequelize.define(
    ...
    {
        // hooks para modificar el modelo antes de la validación
        hooks: {
            beforeValidate: function (articulo, options) {
                if (typeof articulo.Nombre === "string") {
                    articulo.Nombre = articulo.Nombre.toUpperCase().trim(); // convierte a mayúsculas y elimina espacios
                }
            },
        },
    }
